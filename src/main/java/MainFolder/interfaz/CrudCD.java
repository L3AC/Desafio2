...
import MainFolder.modelos.CDAudio;
...
public class CrudCD extends javax.swing.JFrame {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(CrudCD.class.getName());
    ...
    public CrudCD() {
        ...
        Validacion.permitirSolo(txtArtista, "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZáéíóúÁÉÍÓÚñÑ0123456789 ", 100);
        Validacion.permitirSolo(txtNC, "0123456789", 5);
        //OCULTAR COLUMNAS
    ...
    private boolean validarCampos() {
        ...
        if (txtNC.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(this, "El número de canciones es obligatorio.");
            return false;
        }
    ...
    private void initComponents() {
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "", "Código", "Título", "Disponibles", "Artista", "Género", "Duración", "Num. Canciones"
            }
        ) {
        ...
        jLabel7.setText("GESTIÓN DE CD AUDIO");
        ...
        jLabel8.setText("Número canciones");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(161, 161, 161)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(txtArtista, javax.swing.GroupLayout.PREFERRED_SIZE, 164, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void tablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaMouseClicked
        if (evt.getClickCount() == 2) {
            ...
            if (fila >= 0) {
                ...
                txtGenero.setText(modelo.getValueAt(fila, 4).toString());
                txtArtista.setText(modelo.getValueAt(fila, 5).toString());
                txtDuracion.setText(modelo.getValueAt(fila, 6).toString());
                txtNC.setText(modelo.getValueAt(fila, 7).toString());
            }
        }
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        if (validarCampos()) {
            CDAudio cd_audio = new CDAudio();
            cd_audio.setCodigo(txtCodigo.getText().trim());
            cd_audio.setTitulo(txtTitulo.getText().trim());
            cd_audio.setArtista(txtArtista.getText().trim());
            cd_audio.setUnidadesDisponibles((Integer) Integer.parseInt(txtUD.getText().trim()));
            cd_audio.setGenero(txtGenero.getText().trim());

            String duracionStr = txtDuracion.getText().trim();
            java.sql.Time duracion = java.sql.Time.valueOf(duracionStr);
            cd_audio.setDuracion(duracion);
            cd_audio.setNumCanciones(parseInt(txtNC.getText().trim()));

            cd_audio.setTipo("cd_audio");

            if (dao.agregarMaterial(cd_audio)) {
                JOptionPane.showMessageDialog(this, "CDAudio agregado correctamente.");
                limpiarCampos();
                listar();
            } else {
                JOptionPane.showMessageDialog(this, "Error al agregar el cd_audio.", "Error", JOptionPane.ERROR_MESSAGE);
            }
        }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if (fila >= 0) {
            ...
            int confirm = JOptionPane.showConfirmDialog(this, "¿Está seguro de eliminar este cd_audio?", "Confirmar eliminación", JOptionPane.YES_NO_OPTION);
            if (confirm == JOptionPane.YES_OPTION) {
                if (dao.eliminarMaterial(id)) {
                    ...
                    JOptionPane.showMessageDialog(this, "Error al eliminar el cd_audio.", "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        } else {
            JOptionPane.showMessageDialog(this, "Seleccione un cd_audio de la tabla para eliminar.");
        }
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        try {
            ...
            if (validarCampos()) {
                ...
                if (dao.modificarMaterial(cd_audio)) {
                    JOptionPane.showMessageDialog(this, "CDAudio modificada correctamente.");
                    listar();
                } else {
                    JOptionPane.showMessageDialog(this, "Error al modificar la cd_audio.", "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(this, "Seleccione una cd_audio de la tabla para modificar.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new CrudCD().setVisible(true));
    }
